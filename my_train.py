...
from my_utils import DataAugmentation, Head, Loss, MultiCropWrapper, clip_gradients
...
def main():
    ...
    parser.add_argument("-l", "--logging-freq", type=int, default=500)
    ...
    print(vars(args))
    # Parameters
    vit_name, dim = "vit_small_patch16_224", 384
    path_dataset_train = pathlib.Path("imagenette2-320/train")
    path_dataset_val = pathlib.Path("imagenette2-320/val")
    path_labels = pathlib.Path("imagenette_labels.json")
